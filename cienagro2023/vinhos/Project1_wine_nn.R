...
x
heatmap(t(x$table), Rowv=NA, Colv=NA, symm=TRUE, revC=TRUE)
...
plot(pca_scores[, 1:2], col = class_colors[trainset$Class],
     main = "Principal Component Analysis",
     xlab = "Componente Principal 1", ylab = "Componente Principal 2")

# Adiciona a legenda das classes
legend("topright", legend = levels(trainset$Class), fill = class_colors, bty = "n")
